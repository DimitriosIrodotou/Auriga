...
class auriga_book():
    ...
    def make_book_overview(self, level):
        pdf = PdfPages('../plots/auriga_book_lvl%d.pdf' % level)
        ...
        book.time_evolution.bfld(pdf, self, [level])  # early time eponential ( < z=2 ), full time linear
...
b = auriga_book()
b.add_directory("/freya/ptmp/mpa/rdp/Auriga/Dedner", 5)
b.make_book_overview(5)