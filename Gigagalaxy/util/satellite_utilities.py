...
def return_infall_times(isub, t, t0, sf, cfirst_infall=True, cfinal_infall=False, cfirst_peri=False, cthreeR200_infall=False):
    ...
    snap_numbers, redshifts, subfind_indices, tree_indices, ff_tree_indices, fof_indices = t.return_subhalo_first_progenitors(isub, target_FOF=
    sf.data['sgnr'][isub])
...
def return_Lorb_final(t, host_first_progenitors, first_progenitors, hubbleparam):
    ...
    # r200 = t.data['frc2'][ff_tree_indices0]/(1.0+redshifts0)/hubbleparam #R200 over time of main halo; note that the tree reader does not correct
